 ...
 */
const description =
  "Passionate web developer with a Bachelor's in Computer Science (B.C.S), currently pursuing an MCA. Skilled in JavaScript, React JS, Node.js, MongoDB, HTML5, CSS3, TailwindCSS, Git, and GitHub.";
